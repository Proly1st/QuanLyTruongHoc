...
@section('content')
    ...
    <main id="main-container">
        ...
        <div class="content pt-0">
            <!-- Default Table Style -->
            <h2 class="content-heading pt-4">Danh sách nhân viên</h2>
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="btabswo-static-home" role="tabpanel">
                        <div class="block-header text-right">
                            <button type="button" class="btn btn-primary min-width-125 ml-auto" onclick="openModalCreateEmployee()">Thêm mới</button>
                    </div>
                        <div class="block-content block-content-full">
                            <div class="col-sm-12 col-md-12 col-xl-12 p-0">
                                <div class="table-responsive">
                                    <table id="table-employee" class="table table-bordered">
                                        <thead>
                                            <tr>
                    ...
                    <div class="tab-pane" id="btabswo-static-profile" role="tabpanel">
                        ...
                        <div class="block-content block-content-full">
                            <div class="col-sm-12 col-md-12 col-xl-12 p-0">
                                <div class="table-responsive">
                                    <table id="table-employee-off" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="text-center">STT</th>
                                                <th class="text-center">Họ & Tên</th>
    ...
    <!-- END Main Container -->
    @include('Admin.manage.employee.create')
    @include('Admin.manage.employee.edit')
    
@endsection
@push('js')
    <script src="{{ asset('assets/js/Admin/manage/employee/index.js')}}"></script>
@endpush
