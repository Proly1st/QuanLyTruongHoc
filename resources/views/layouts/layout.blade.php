...
<html lang="en" class="no-focus">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/css/template_custom.css') }}">
...
{{--        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed side-trans-enabled page-header-fixed">--}}
        <div id="page-container" class="enable-page-overlay side-scroll page-header-modern side-trans-enabled page-header-fixed sidebar-o">
            <!-- Side Overlay-->
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section">
                        ...
                        {{--  <select class="text-center" id="change-branch" name="example-select" data-select-not-empty>
                            @if(isset($branch))
                                <option class="text-center" value="-1">Toàn chi nhánh</option>
                                @foreach ($branch as $item)
                                    <option class="text-center" value="{{ $item->id }}">{{ $item->branch_name }}</option>
                                @endforeach
                            @endif
                        </select>  --}}
                    </div>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                                <a class="dropdown-item" href="{{ route('profile') }}">
                                    <i class="si si-user mr-5"></i> Thông tin
                                </a>
                                {{-- <div class="dropdown-divider"></div> --}}
                                ...
                                <a class="dropdown-item" href="op_auth_signin.html">
                                    <i class="si si-logout mr-5"></i> Đăng xuất
                                </a>
                            </div>
                        </div>
                        <!-- END User Dropdown -->
        ...
        <!-- Page JS Code -->
        <script src="{{ asset('assets/js/Admin/manage/table.js') }}"></script>
